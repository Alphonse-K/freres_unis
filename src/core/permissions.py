...
class Permissions(str, Enum):
    ...
    VALIDATE_CLIENT_CARD = "client_card:validate"
    ...
    CREATE_EMPLOYEE_CARD = "CREATE_EMPLOYEE_CARD"
    READ_EMPLOYEE_CARD   = "READ_EMPLOYEE_CARD"
    APPROVE_EMPLOYEE_CARD = "APPROVE_EMPLOYEE_CARD"
    REVOKE_EMPLOYEE_CARD  = "REVOKE_EMPLOYEE_CARD"

    CREATE_EMPLOYEE_SALARY = "CREATE_EMPLOYEE_SALARY"
    APPROVE_EMPLOYEE_SALARY = "APPROVE_EMPLOYEE_SALARY"
